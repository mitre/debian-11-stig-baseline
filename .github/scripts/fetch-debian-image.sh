...
#
# Defaults to the official Debian 11 (bullseye) "genericcloud" image published
...
#
# Optional env:
#   DEBIAN_IMAGE_URL -- full URL to a .qcow2 (default: latest bullseye genericcloud amd64)
# Optional args:
#   $1 -- output path (default: debian-image.qcow2)

set -euo pipefail

DEFAULT_URL="https://cloud.debian.org/images/cloud/bullseye/latest/debian-11-genericcloud-amd64.qcow2"
